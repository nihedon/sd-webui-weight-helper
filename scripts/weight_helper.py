...
def on_ui_settings():
    ...
    shared.opts.add_option('weight_helper_disp_unet_slider', shared.OptionInfo(False, 'Display UNet slider', section=section))
    ...
    shared.opts.add_option('weight_helper_disp_dyn_slider', shared.OptionInfo(False, 'Display Dyn slider', section=section))
